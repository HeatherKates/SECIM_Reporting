...
ReportInput <- Generate_Report_Inputs(client="Dudeja.Serum",samples_to_drop=NULL,mzmine_version=2,
                                               ReferenceLevel="Serum_WT",Input="Dudeja-Metabolomics_Serum.xlsx",
                                               contrast_var="Class",num_meta=1,anova_formula=NULL,lm_model=NULL,
                                               test_type="t.test",subset=NULL,metid_DB_file="kegg_ms1_database0.0.3.rda")
saveRDS(Client_Data_Download,file="Dudeja.Serum.ReportingInput2023-08-17.RDATA")
