...
valid_pathways <- compound_pathways[sapply(compound_pathways, validate_pathway)]
...
filtered_pathways <- paste0("hsa", filtered_pathways)

# Function to visualize pathways
visualize_pathway <- function(pathway_id, cpd_data, output_dir) {
  tryCatch({
    pathview(gene.data = NULL, cpd.data = cpd_data, pathway.id = pathway_id, species = "hsa", out.suffix = pathway_id, kegg.native = TRUE, kegg.dir = output_dir)
  }, error = function(e) {
...
for (pathway_id in filtered_pathways) {
  ...
  # Print the image in the R Markdown document
  img_file <- file.path(output_dir, paste0(pathway_id, ".pathview.png"))
  if (file.exists(img_file)) {
    cat("### Pathway: ", pathway_id, "\n")
