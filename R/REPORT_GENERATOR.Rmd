...
if(test_type=="t.test"){
Client_Data_Download_out[["README"]] <- read.csv("../../SECIM_Reporting/InputFiles/ttest.README.csv")
}else{
Client_Data_Download_out[["README"]] <- read.csv("../SECIM_Reporting/InputFiles/ANOVA.emmeans.README.csv")}
...
load("../SECIM_Reporting/InputFiles/KEGG_network.RDATA")
```
...
assign(paste0("node.data", i, "up"), get(paste0("node.data", i, "up")) %>%
  mutate(input = as.character(input)))
    ...
    KEGG_map <- readRDS("../SECIM_Reporting/InputFiles/KEGG_map.df.RData")
