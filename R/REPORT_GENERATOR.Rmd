...
#We want to remove the metadata row(s) and all non sample cols from Client_Data_Download
 PCA_DATA <- t(rbind(Client_Data_Download_out[["Neg.processed.data"]][,3:(num_samples+2)],
 Client_Data_Download_out[["Pos.processed.data"]][-(1:num_of_metadata-1),3:(num_samples+2)]))
